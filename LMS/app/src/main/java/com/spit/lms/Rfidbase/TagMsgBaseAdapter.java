...
public class TagMsgBaseAdapter extends BaseAdapter {
    // 定义信息的集合体
    private ArrayList<com.spit.lms.Rfidbase.TagMsgEntity> mTagMsgEntitys;
    // 定义上下文
    private Context mCtx;
    // 动态加载Layout布局文件
    private LayoutInflater mLayoutInflater;

    public TagMsgBaseAdapter(ArrayList<com.spit.lms.Rfidbase.TagMsgEntity> mTagMsgEntitys, Context mCtx) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        // 根据listview的位置提取聊天信息
        com.spit.lms.Rfidbase.TagMsgEntity tagMsgEntity = mTagMsgEntitys.get(position);
        // 每条聊天信息显示的布局组件
    ...
    public void setChangeItem(com.spit.lms.Rfidbase.TagMsgEntity item, int position) {
        com.spit.lms.Rfidbase.TagMsgEntity tag = (com.spit.lms.Rfidbase.TagMsgEntity)mTagMsgEntitys.get(position);
    ...
    public void addItem(com.spit.lms.Rfidbase.TagMsgEntity item) {
...
//    }
    ...
    public int reflashData(com.spit.lms.Rfidbase.TagMsgEntity item) {
        boolean isAdd = true;
        int p = -1;
        String epc = "";
        String tid = "";
